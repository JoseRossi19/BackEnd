 ...
 */
package com.portfolio.jgr.Security;

import com.portfolio.jgr.Security.Service.UserDetailsImpl;
import com.portfolio.jgr.Security.jwt.JwtEntryPoint;
import com.portfolio.jgr.Security.jwt.JwtTokenFilter;
...
public class MainSecurity extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        List<String> list2 = Arrays.asList(new String[]{https://backendok.herokuapp.com});
